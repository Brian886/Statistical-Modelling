...
# d_pred_UCOMP/d_UHOURS = 3.299e+00 + 2*-4.062e-04*UHOURS + 1.292e-01*MALE

# marg effect for a female household head with an average number of unemployed hours
avg_UHOURS <- mean(unemp_data$UHOURS)

3.299e+00 + 2*-4.062e-04*avg_UHOURS + 1.292e-01*0
# If our female household head spend an additional hour unemployed compared to the average,
# while all other parameters remain the same, the household can expect an additional 2.6 USD compensation
...
# the variable has no significant effect on midterm scores.  
